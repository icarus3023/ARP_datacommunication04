...
BOOL CEthernetLayer::Receive( unsigned char* ppayload )
{
	...
	BOOL bSuccess = FALSE;
	ETHERNET_HEADER broadcast;
	memset(broadcast.enet_srcaddr.addrs, 0xff, 6);
	if (memcmp((char *)pFrame->enet_dstaddr.S_un.s_ether_addr, (char *)broadcast.enet_srcaddr.S_un.s_ether_addr, 6) == 0) {
