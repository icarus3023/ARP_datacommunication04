...
public:
	...
	//Ãß°¡
	virtual void	SetDestinAddress(unsigned char* pAddress) { return; }
	virtual void	SetSourceAddress(unsigned char* pAddress) { return; }
	virtual void	SetDestinAddress(unsigned short pAddress) { return; }
	virtual void	SetSourceAddress(unsigned short pAddress) { return; }
	virtual void setType(unsigned short type) { return; }
